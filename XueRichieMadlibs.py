...
def generateBody():
  body = "<p>" + replaceWords(replaceNamesAndPlaces(text4,names,places), nouns, verbs, adjectives, adverbs) + "</p>\n"
  body += '''          <img src="pokemon.jpg" alt="pokemonBook" width="500" height="600"''' 
  return body
...
page = page.replace("_STYLE_",generateStyle())
